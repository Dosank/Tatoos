...
const PortfolioLanding = () => {
    let title = '¿Quien soy?',
        description = 'Mi nombre es Bruno, tatuador desde la cuna papá , maquinola del desierto patagonico cuna de los linces de agua dulce, paladin de la milanesa frita , maestruli de la noche, indio de la bicicleta. Maestruli troesma';
